...
export function RuleRecommendations() {
  ...
  const handleAcceptRecommendation = (recommendation: any) => {
    ...
    setDismissedRecommendations(prev => new Set([...prev, recommendation.rule.id]));
  };
      ...
      {isGenerating ? (
          ...
          {visibleRecommendations.map((recommendation, index) => (
            <Card key={index} className="card-modern group hover:shadow-lg transition-all">
              <CardHeader className="pb-4">
                <div className="flex items-start justify-between">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleDismissRecommendation(recommendation.rule.id)}
              ...
              <CardContent className="space-y-4">
                {/* Metrics */}
                <div className="flex items-center space-x-4">
                  <Badge className={`badge-modern ${getImpactColor(recommendation.impact)}`}>
                ...
                <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline">{recommendation.rule.type}</Badge>
                  </div>
        ...
        <Card className="card-modern">
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-xl font-semibold mb-3">No Recommendations Available</h3>
            <p className="text-body mb-6">
              Upload more data or click "Refresh Recommendations" to get AI-powered rule suggestions
            </p>
