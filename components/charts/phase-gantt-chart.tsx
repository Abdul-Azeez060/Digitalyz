  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Visual breakdown of tasks and resource allocation across project
          phases
        </CardDescription>
      </CardHeader>
            ...
            <div key={phase.phase} className="space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Badge className="font-mono">Phase {phase.phase}</Badge>
              ...
              <div className="relative">
                <div className="w-full bg-gray-200 rounded-full h-6">
                  <div
                    className={`h-6 rounded-full ${getPhaseColor(
                      phase.phase
              ...
              <div className="ml-4 space-y-1">
                {phase.tasks.slice(0, 3).map((task) => (
                  <div
                    ...
                    <div
                      className={`w-2 h-2 rounded-full ${getPhaseColor(
                        phase.phase
                      )}`}
                    />
              ...
              <div className="ml-4">
                <div className="flex flex-wrap gap-1">
                  {phase.workers.slice(0, 4).map((workerId) => {
                    ...
                    return (
                      <Badge key={workerId} className="text-xs">
          ...
          <div className="flex items-center space-x-2 overflow-x-auto pb-2">
            {phaseData.map((phase, index) => (
              <div
                ...
                <div
                  className={`px-3 py-2 rounded-lg text-white text-sm font-medium ${getPhaseColor(
                    phase.phase
                  )}`}>
                  Phase {phase.phase}
                </div>
