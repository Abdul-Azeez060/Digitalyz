...
export function NaturalLanguageCorrector({
  dataType,
  data,
}: NaturalLanguageCorrectorProps) {
  ...
  const handleProcessCommand = async () => {
    ...
    try {
      ...
      const result = await aiService.processNaturalLanguageCorrection(
        command,
        data,
        dataType
      );
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h4 className="font-medium">
                    Preview Changes ({previewChanges.length})
                  </h4>
