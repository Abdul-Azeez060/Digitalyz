...
export default function UploadPage() {
  ...
  const uploadConfigs = [
    {
      ...
      title: "Clients Data",
      description:
        "Upload client information with priorities, budgets, and group tags",
      expectedHeaders: [
        "id",
        "name",
        "priority",
    ...
    },
    {
      ...
      title: "Workers Data",
      description:
        "Upload worker skills, capacity, availability, and group assignments",
      expectedHeaders: [
        "id",
        "name",
        "skills",
  ...
  const uploadedCount = uploadConfigs.filter(
    (config) => config.uploaded
  ).length;
      ...
      clients: [
        {
          ...
          groupTag: "enterprise",
          attributesJSON:
            '{"industry": "technology", "size": "large", "urgency": "high"}',
          phases: "1,2,3",
        },
        {
          id: "client-002",
          ...
          groupTag: "startup",
          attributesJSON:
            '{"industry": "fintech", "size": "small", "urgency": "medium"}',
          phases: "1,2",
        },
      ],
      workers: [
    ...
    <div className="page-content">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="page-subtitle">
              Upload your CSV or Excel files with comprehensive validation and
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-indigo-100">
                Comprehensive validation including relationship checks, group
                constraints, phase-slot analysis, and circular dependency
                detection
              </p>
            </div>
      ...
      <Card className="card-modern mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Our enhanced AI automatically detects and flags these data issues
            and relationships
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {hasValidationErrors && (
        <Alert className="mb-8 border-red-200 bg-red-50 rounded-2xl">
          ...
          <AlertDescription className="text-red-800 font-medium">
            Critical validation errors found. Please review your data in the
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <CardDescription className="text-body">
                Download comprehensive templates with realistic data
            ...
            {[
              {
                ...
                icon: Users,
                color: "#6366f1",
                features: ["Group tags", "Attributes JSON", "Task references"],
              },
              {
              ...
              },
              {
                ...
                icon: Zap,
                color: "#8b5cf6",
                features: ["Categories", "Preferred phases", "Dependencies"],
              },
            ].map((template, index) => (
              <div
                key={index}
              ...
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    CSV, Excel (.xlsx), and legacy Excel (.xls) formats
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700">
                    Includes all new fields: groups, attributes, slots,
                    categories
                  </p>
                </div>
              </div>
